...
import { getCellValue, getDropdownList, getFlowdata, getSheetIndex, mergeBorder, setDropcownValue, } from "@nde-sheet/core";
...
const DropDownList = () => {
    ...
    return (_jsx("div", { id: "luckysheet-dataVerification-dropdown-List", style: position, ref: containerRef, onClick: (e) => e.stopPropagation(), onChange: (e) => e.stopPropagation(), onKeyDown: (e) => e.stopPropagation(), onMouseDown: (e) => e.stopPropagation(), onMouseUp: (e) => e.stopPropagation(), tabIndex: 0, children: list.map((v, i) => (_jsxs("div", { className: "dropdown-List-item", onClick: () => {
                setContext((ctx) => {
                    const arr = selected;
            ...
            }, tabIndex: 0, children: [_jsx(SVGIcon, { name: "check", width: 12, style: {
