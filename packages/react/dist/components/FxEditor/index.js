...
import { locale, getFlowdata, cancelNormalSelected, getCellValue, updateCell, getInlineStringNoStyle, isInlineStringCell, escapeScriptTag, moveHighlightCell, handleFormulaInput, rangeHightlightselected, valueShowEs, isShowHidenCR, escapeHTMLTag, isAllowEdit, } from "@nde-sheet/core";
...
const FxEditor = () => {
    ...
    return (_jsx("aside", { children: _jsxs("div", { className: "fortune-fx-editor", children: [_jsx(NameBox, {}), _jsx("div", { className: "fortune-fx-icon", children: _jsx(SVGIcon, { name: "fx", width: 18, height: 18 }) }), _jsxs("div", { ref: inputContainerRef, className: "fortune-fx-input-container", children: [_jsx(ContentEditable, { innerRef: (e) => {
                                refs.fxInput.current = e;
                            }, className: "fortune-fx-input", role: "textbox", id: "luckysheet-functionbox-cell", "aria-label": info.currentCellInput, onFocus: onFocus, onKeyDown: onKeyDown, onChange: onChange, onBlur: () => setFocused(false), tabIndex: 0, allowEdit: allowEdit }), focused && (_jsxs(_Fragment, { children: [_jsx(FormulaSearch, { style: {
